...
public class CustomerTransferController {
    ...
    @RequiresPermissions(value = {"customerTransfer:list","客户移交历史页面"},logical = Logical.OR)
    @RequestMapping("/list")
    ...
    @RequiresPermissions(value = {"customerTransfer:delete","客户移交历史删除"},logical = Logical.OR)
    @ResponseBody
    ...
    @RequiresPermissions(value = {"customerTransfer:saveOrUpdate","客户移交历史新增/编辑"},logical = Logical.OR)
    @ResponseBody
